...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN PA0           // Set a custom pin for the controller fan
...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_PIN PB10                  // Override the default pin if needed
...
#define HOMING_BACKOFF_POST_MM { (-X_MIN_POS), (-Y_MIN_POS), 0 }  // (linear=mm, rotational=°) Backoff from endstops after homing
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  72           // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.2f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  72           // (Hz) The default dominant resonant frequency on the Y axis.
    #define SHAPING_ZETA_Y  0.2f       // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #define SHAPING_MIN_FREQ  50        // By default the minimum of the shaping frequencies. Override to affect SRAM usage.
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 80*60, 80*60, 10*60, 4*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
   ...
   */
  //#define DISPLAY_SLEEP_MINUTES 90  // (minutes) Timeout before turning off the screen. Set with M255 S.
